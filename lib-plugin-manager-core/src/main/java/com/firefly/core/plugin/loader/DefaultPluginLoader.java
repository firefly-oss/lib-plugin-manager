...
public class DefaultPluginLoader implements PluginLoader {
        ...
        return Mono.fromCallable(() -> {
            try {
                ...
                if (properties.getSecurity().isEnforceSecurityChecks()) {
                    ...
                    Set<com.firefly.core.plugin.security.PluginPermission> permissions = createPermissionsForPlugin(pluginId);
                ...
                ServiceLoader<com.firefly.core.plugin.api.Plugin> serviceLoader =
                        ServiceLoader.load(com.firefly.core.plugin.api.Plugin.class, classLoader);
                ...
                com.firefly.core.plugin.api.Plugin pluginInstance = serviceLoader.findFirst()
                        .orElseThrow(() -> {
                ...
                if (!metadataPluginId.equals(pluginId)) {
                    ...
                    if (properties.getSecurity().isEnforceSecurityChecks()) {
                        Set<com.firefly.core.plugin.security.PluginPermission> permissions = createPermissionsForPlugin(metadataPluginId);
     ...
     */
    private Set<com.firefly.core.plugin.security.PluginPermission> createPermissionsForPlugin(String pluginId) {
        Set<com.firefly.core.plugin.security.PluginPermission> permissions = new HashSet<>();
        ...
        if (allowFileAccess) {
            if (allowedDirectories.isEmpty()) {
                ...
                permissions.add(new com.firefly.core.plugin.security.PluginPermission(
                        com.firefly.core.plugin.security.PluginPermission.Type.FILE_SYSTEM));
            } else {
                // Allow access to specific directories
                for (String dir : allowedDirectories) {
                    permissions.add(new com.firefly.core.plugin.security.PluginPermission(
                            com.firefly.core.plugin.security.PluginPermission.Type.FILE_SYSTEM, dir));
                }
            }
        }
        ...
        if (allowNetworkAccess) {
            if (allowedHosts.isEmpty()) {
                ...
                permissions.add(new com.firefly.core.plugin.security.PluginPermission(
                        com.firefly.core.plugin.security.PluginPermission.Type.NETWORK));
            } else {
                // Allow access to specific hosts
                for (String host : allowedHosts) {
                    permissions.add(new com.firefly.core.plugin.security.PluginPermission(
                            com.firefly.core.plugin.security.PluginPermission.Type.NETWORK, host));
                }
            }
        }
        ...
        permissions.add(new com.firefly.core.plugin.security.PluginPermission(
                com.firefly.core.plugin.security.PluginPermission.Type.SYSTEM_PROPERTIES, null, "read"));

        // Add thread permission (limited)
        permissions.add(new com.firefly.core.plugin.security.PluginPermission(
                com.firefly.core.plugin.security.PluginPermission.Type.THREAD));
