...
public class KafkaPluginEventBus implements PluginEventBus {
    ...
    private static final String DEFAULT_TOPIC = "firefly-plugin-events";
    private static final String DEFAULT_CONSUMER_GROUP = "firefly-plugin-manager";

    private final ObjectMapper objectMapper;
    private final KafkaPluginEventBusProperties properties;
     ...
     * @param properties the Kafka event bus properties
     */
    @Autowired
    public KafkaPluginEventBus(ObjectMapper objectMapper, KafkaPluginEventBusProperties properties) {
    ...
    public Mono<Void> initialize() {
        ...
        return subscribeTopic(DEFAULT_TOPIC).then();
    }
    ...
    public Mono<Void> shutdown() {
        ...
        return Mono.fromRunnable(() -> {
            ...
            // Close all receivers
            receivers.values().forEach(KafkaReceiver::close);
            receivers.clear();
    ...
    public <T extends PluginEvent> Flux<T> subscribe(Class<T> eventType) {
        return subscribeTopic(DEFAULT_TOPIC)
