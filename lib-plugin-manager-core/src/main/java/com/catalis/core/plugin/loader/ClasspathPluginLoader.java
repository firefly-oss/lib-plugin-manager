...
public class ClasspathPluginLoader implements PluginLoader {
     ...
     */
    private Mono<com.catalis.core.plugin.api.Plugin> createWrapperPlugin(Class<?> pluginClass) {
        try {
            // Get the @Plugin annotation
            com.catalis.core.plugin.annotation.Plugin annotation = pluginClass.getAnnotation(com.catalis.core.plugin.annotation.Plugin.class);
            if (annotation == null) {
