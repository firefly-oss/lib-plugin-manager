...
public class DefaultPluginLoaderTest {
    ...
    void testCreatePermissionsForPlugin() throws Exception {
        ...
        Set<com.firefly.core.plugin.security.PluginPermission> permissions =
                (Set<com.firefly.core.plugin.security.PluginPermission>) createPermissionsMethod.invoke(pluginLoader, "test-plugin");
