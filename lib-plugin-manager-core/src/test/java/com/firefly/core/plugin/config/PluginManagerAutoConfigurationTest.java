...
public class PluginManagerAutoConfigurationTest {
    ...
    static class CustomPluginEventBus implements PluginEventBus {
        @Override
        public reactor.core.publisher.Mono<Void> publish(com.firefly.core.plugin.event.PluginEvent event) {
            return reactor.core.publisher.Mono.empty();
        }

        @Override
        public reactor.core.publisher.Mono<Void> publish(String topic, com.firefly.core.plugin.event.PluginEvent event) {
            return reactor.core.publisher.Mono.empty();
        }

        @Override
        public <T extends com.firefly.core.plugin.event.PluginEvent> reactor.core.publisher.Flux<T> subscribe(Class<T> eventType) {
            return reactor.core.publisher.Flux.empty();
        }

        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.event.PluginEvent> subscribeToPlugin(String pluginId) {
            return reactor.core.publisher.Flux.empty();
        }

        @Override
        public <T extends com.firefly.core.plugin.event.PluginEvent> reactor.core.publisher.Flux<T> subscribeToPlugin(String pluginId, Class<T> eventType) {
            return reactor.core.publisher.Flux.empty();
        }

        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.event.PluginEvent> subscribeTopic(String topic) {
            return reactor.core.publisher.Flux.empty();
        }

        @Override
        public <T extends com.firefly.core.plugin.event.PluginEvent> reactor.core.publisher.Flux<T> subscribeTopic(String topic, Class<T> eventType) {
            return reactor.core.publisher.Flux.empty();
        }
    ...
    static class CustomPluginRegistry implements PluginRegistry {
        @Override
        public reactor.core.publisher.Mono<Void> registerPlugin(com.firefly.core.plugin.api.Plugin plugin) {
            return reactor.core.publisher.Mono.empty();
        }
        ...
        @Override
        public reactor.core.publisher.Mono<com.firefly.core.plugin.api.Plugin> getPlugin(String pluginId) {
            return reactor.core.publisher.Mono.empty();
        }

        @Override
        public reactor.core.publisher.Mono<com.firefly.core.plugin.model.PluginDescriptor> getPluginDescriptor(String pluginId) {
            return reactor.core.publisher.Mono.empty();
        }

        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.api.Plugin> getAllPlugins() {
            return reactor.core.publisher.Flux.empty();
        }

        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.model.PluginDescriptor> getAllPluginDescriptors() {
            return reactor.core.publisher.Flux.empty();
        }

        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.api.Plugin> getPluginsByState(com.firefly.core.plugin.model.PluginState state) {
            return reactor.core.publisher.Flux.empty();
        }
    ...
    static class CustomPluginLoader implements PluginLoader {
        @Override
        public reactor.core.publisher.Mono<com.firefly.core.plugin.api.Plugin> loadPlugin(java.nio.file.Path pluginPath) {
            return reactor.core.publisher.Mono.empty();
        }

        @Override
        public reactor.core.publisher.Mono<com.firefly.core.plugin.api.Plugin> loadPluginFromGit(java.net.URI repositoryUri, String branch) {
            return reactor.core.publisher.Mono.empty();
        }

        @Override
        public reactor.core.publisher.Mono<com.firefly.core.plugin.api.Plugin> loadPluginFromGit(java.net.URI repositoryUri) {
            return reactor.core.publisher.Mono.empty();
        }

        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.api.Plugin> loadPluginsFromClasspath(String basePackage) {
            return reactor.core.publisher.Flux.empty();
        }

        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.api.Plugin> loadPluginsFromClasspath() {
            return reactor.core.publisher.Flux.empty();
        }
    }
    ...
    static class CustomPluginManager implements PluginManager {
        ...
        @Override
        public reactor.core.publisher.Mono<com.firefly.core.plugin.model.PluginDescriptor> installPlugin(java.nio.file.Path pluginPath) {
            return reactor.core.publisher.Mono.empty();
        }
        ...
        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.model.PluginDescriptor> getAllPlugins() {
            return reactor.core.publisher.Flux.empty();
        }

        @Override
        public reactor.core.publisher.Mono<com.firefly.core.plugin.model.PluginDescriptor> getPlugin(String pluginId) {
            return reactor.core.publisher.Mono.empty();
        }
        ...
        @Override
        public reactor.core.publisher.Mono<com.firefly.core.plugin.model.PluginDescriptor> installPluginFromGit(java.net.URI repositoryUri, String branch) {
            return reactor.core.publisher.Mono.empty();
        }

        @Override
        public reactor.core.publisher.Mono<com.firefly.core.plugin.model.PluginDescriptor> installPluginFromGit(java.net.URI repositoryUri) {
            return reactor.core.publisher.Mono.empty();
        }

        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.model.PluginDescriptor> installPluginsFromClasspath(String basePackage) {
            return reactor.core.publisher.Flux.empty();
        }

        @Override
        public reactor.core.publisher.Flux<com.firefly.core.plugin.model.PluginDescriptor> installPluginsFromClasspath() {
            return reactor.core.publisher.Flux.empty();
        }
    }
